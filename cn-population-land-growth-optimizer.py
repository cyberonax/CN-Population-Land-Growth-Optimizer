...
# =============================================================================
GOVERNMENTS = {
    "Anarchy": {"happiness": 0, "land": 1.00, "soldier_eff": 1.00, "infra_cost": 1.00, "imp_upkeep": 1.00, "mil_upkeep": 1.00, "spy_attack": 1.00},
    "Capitalist": {"happiness": 0, "land": 1.05, "soldier_eff": 1.00, "infra_cost": 0.95, "imp_upkeep": 0.95, "mil_upkeep": 1.00, "spy_attack": 1.00},
    "Communist": {"happiness": 0, "land": 1.05, "soldier_eff": 1.08, "infra_cost": 1.00, "imp_upkeep": 1.00, "mil_upkeep": 0.98, "spy_attack": 1.10},
    "Democracy": {"happiness": 1, "land": 1.00, "soldier_eff": 1.08, "infra_cost": 1.00, "imp_upkeep": 1.00, "mil_upkeep": 1.00, "spy_attack": 1.00},
    "Dictatorship": {"happiness": 0, "land": 1.00, "soldier_eff": 1.08, "infra_cost": 0.95, "imp_upkeep": 1.00, "mil_upkeep": 0.98, "spy_attack": 1.00},
    "Federal Government": {"happiness": 0, "land": 1.00, "soldier_eff": 1.08, "infra_cost": 0.95, "imp_upkeep": 0.95, "mil_upkeep": 1.00, "spy_attack": 1.00},
    "Monarchy": {"happiness": 1, "land": 1.05, "soldier_eff": 1.00, "infra_cost": 0.95, "imp_upkeep": 1.00, "mil_upkeep": 1.00, "spy_attack": 1.00},
    "Republic": {"happiness": 0, "land": 1.05, "soldier_eff": 1.00, "infra_cost": 0.95, "imp_upkeep": 1.00, "mil_upkeep": 1.00, "spy_attack": 1.10},
    "Revolutionary Government": {"happiness": 1, "land": 1.00, "soldier_eff": 1.00, "infra_cost": 0.95, "imp_upkeep": 0.95, "mil_upkeep": 1.00, "spy_attack": 1.00},
    "Totalitarian State": {"happiness": 1, "land": 1.05, "soldier_eff": 1.00, "infra_cost": 1.00, "imp_upkeep": 1.00, "mil_upkeep": 0.98, "spy_attack": 1.00},
    "Transitional": {"happiness": 0, "land": 1.05, "soldier_eff": 1.08, "infra_cost": 1.00, "imp_upkeep": 0.95, "mil_upkeep": 1.00, "spy_attack": 1.10}
}
...
# =============================================================================
# Other Key Variables
# War mode indicates whether the nation is at war.
...
def calculate_population(government, defcon, war_mode, infra, tech, base_pop=1000, happiness_factor=100):
    ...
    return adjusted_population * war_multiplier * tax_multiplier
...
def calculate_land_growth(government, infra, base_land):
    ...
    return (base_land * natural_growth) * infra_bonus * gov_land_bonus
...
st.write("This simulation uses formulas from the official Cyber Nations website to optimize settings for maximum population and land growth. (Tax rate fixed at 30%.)")
...
if st.sidebar.button("Optimize"):
    ...
    # Sort the DataFrame by "Fitness" (primary) and "DEFCON" (secondary) in descending order
